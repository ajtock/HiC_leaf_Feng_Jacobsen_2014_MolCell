...
# Usage:
# ./hicPlotMatrix_after_hicCompareMatrices_ddm1_2_HiC_HindIII_SRR1504824.sh ddm1_2_HiC_HindIII_SRR1504824 Col_0_HiC_HindIII_SRR1504819 T2T_Col '100000' norm_range KR log2ratio
...
hicPlotMatrix --matrix ${OPERATION}_${SAMPLE1}_${SAMPLE2}_${GENOME}_${RESOLUTION}_${NORM}_${CORRECTION}.h5 \
              ...
              --colorMap "plasma" \
              --scoreName "Log2(ddm1/WT) Hi-C ${CORRECTION} counts" \
              --vMin -3.0 \
              --vMax 3.0 \
              --rotationX 45 \
              --dpi 300 \
