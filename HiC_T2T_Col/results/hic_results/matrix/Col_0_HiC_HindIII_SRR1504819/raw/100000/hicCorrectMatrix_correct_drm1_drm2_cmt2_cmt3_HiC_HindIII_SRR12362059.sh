...
# Usage:
# ./hicCorrectMatrix_correct_drm1_drm2_cmt2_cmt3_HiC_HindIII_SRR12362059.sh drm1_drm2_cmt2_cmt3_HiC_HindIII_SRR12362059 T2T_Col '100000' norm_range KR
...
hicCorrectMatrix correct --matrix ${SAMPLE}_${GENOME}_${RESOLUTION}_${NORM}.h5 \
                         ...
                         --filterThreshold -3.4013521458011122 5 \
