...
# Usage:
# ./hicCorrectMatrix_correct_met1_3_HiC_HindIII_SRR1504825.sh met1_3_HiC_HindIII_SRR1504825 T2T_Col '100000' norm_range KR
...
hicCorrectMatrix correct --matrix ${SAMPLE}_${GENOME}_${RESOLUTION}_${NORM}.h5 \
                         ...
                         --filterThreshold -3.5948914585900016 5 \
