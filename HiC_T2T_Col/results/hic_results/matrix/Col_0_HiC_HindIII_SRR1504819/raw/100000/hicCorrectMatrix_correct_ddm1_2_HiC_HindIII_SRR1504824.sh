...
# Usage:
# ./hicCorrectMatrix_correct_ddm1_2_HiC_HindIII_SRR1504824.sh ddm1_2_HiC_HindIII_SRR1504824 T2T_Col '100000' norm_range KR
...
hicCorrectMatrix correct --matrix ${SAMPLE}_${GENOME}_${RESOLUTION}_${NORM}.h5 \
                         ...
                         --filterThreshold -3.6006147092695855 5 \
