...
# Usage:
# ./hicCorrectMatrix_correct_met1_3_HiC_HindIII_SRR1504825.sh met1_3_HiC_HindIII_SRR1504825 T2T_Col '250000' norm_range KR
...
hicCorrectMatrix correct --matrix ${SAMPLE}_${GENOME}_${RESOLUTION}_${NORM}.h5 \
                         ...
                         --filterThreshold -4.156990888505454 5 \
