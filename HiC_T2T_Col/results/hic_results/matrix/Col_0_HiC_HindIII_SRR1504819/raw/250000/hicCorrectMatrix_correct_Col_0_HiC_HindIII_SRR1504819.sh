...
# Usage:
# ./hicCorrectMatrix_correct_Col_0_HiC_HindIII_SRR1504819.sh Col_0_HiC_HindIII_SRR1504819 T2T_Col '250000' norm_range KR
...
hicCorrectMatrix correct --matrix ${SAMPLE}_${GENOME}_${RESOLUTION}_${NORM}.h5 \
                         ...
                         --filterThreshold -3.7850642922054125 5 \
